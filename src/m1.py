...
class CircleChanger(object):
    ...
    def swallow(self, other_circle_changer):
        ...
        newCircleCenter = rg.Point.halfway_to(self.circle.center, other_circle_changer.circle.center)
        newCircleRadius = .5 * self.circle.center.get_distance_from(other_circle_changer.circle.center)
        newCircleFill_color = 'red'
        newColors = self.colors + other_circle_changer.colors

        return CircleChanger(newCircleCenter.x, newCircleCenter.y, newCircleRadius, newCircleFill_color, newColors)
    ...
    def change_to_original_color(self):
        ...
        #   (below).  Third, implement and test this method.
        ################################################################
        self.circle.fill_color = self.preserved
    ...
    def change_to_next_color_in_tuple(self):
        ...
        ################################################################
        self.circle.fill_color = self.colors[self.counter]
